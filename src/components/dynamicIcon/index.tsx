...
import type {regular, solids, logos} from './types.js'


export type iconsListType = regular[number] | solids[number] | logos[number]

type iconComponentPropType = ComponentPropsWithRef<'i'> & {
    name: iconsListType
}
...
export const Icon = forwardRef(({ name, className, ...props }:iconComponentPropType, ref:Ref<HTMLElement>) => {
